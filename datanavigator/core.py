...
class ComponentBrowser(GenericBrowser):
    ...
    def select_signal_piece_dblclick(self, event):
        ...
        if (
            event.inaxes == self.plot_handles["ax_signal_full"] and event.dblclick
        ):  # If the click was inside the time course plot
