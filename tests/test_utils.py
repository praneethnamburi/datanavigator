...
def test_is_path_exists_or_creatable(tmp_path_factory):
    ...
    assert is_path_exists_or_creatable(str(tmp_path_factory.getbasetemp() / "abc12")) == True
    assert is_path_exists_or_creatable(str(tmp_path_factory.getbasetemp() / "<")) == False
